...
def main():
    ...
    seed_data_path = "/root/chatbot/DialTest/data/snips/seed"
    ...
    for j, line in enumerate(lines):
        states_path = "/root/chatbot/DialTest/data/snips/states/out_" + str(j) + ".npy"
        tmp_seed_data_path = "/root/chatbot/DialTest/data/snips/seed_tmp"
